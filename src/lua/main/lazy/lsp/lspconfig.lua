        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                vim.keymap.set("n", "K", function()
                    -- If hover window is already open, close it
                    ...
                    -- Otherwise, open it and store the window handle
                    local original_windows = vim.api.nvim_list_wins()

                    vim.lsp.buf.hover()

                    -- Small delay to wait for the hover window to appear
                ...
                end, { desc = "Toggle hover window" })

                -- Keymap to jump into the last floating window (hover, etc.)
